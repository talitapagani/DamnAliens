    ...
    audio:{
        ...
        */
        play:function(id,repeat,volume){
             ...
             * Bugfix for audio
             * 
             * The former implementation to bind the onEnded event (s.obj.onended = function() {})
             * wasn't working, because the 'onended' property is not supported in all browsers. 
             * The replacement by the addEventListener as a handler for the 'ended' event (without 'on')
             * works fine at least on Chrome. Also, it's the standard way add an event listener
             * 
             * To check is a browser supports the 'onended' property:
             * s.obj.hasOwnProperty('onended') -> returns a boolean: 'true' if it supports; 'false' if it doesn't
             * 
